  ...
  email
	...
	if (token!=null) {
		return (
			<div>
				<h3> Welcome, {email} </h3>
				<Link to="/mcm_gen">MCM Generator</Link> // action updates location state + changes address bar
				...
				<Link to="/mcm_topics/1/edit">Edit MCM Topic #1</Link> // action updates location state + changes address bar
