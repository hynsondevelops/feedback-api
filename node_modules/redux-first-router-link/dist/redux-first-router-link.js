...
exports.default = function (pathname, action, prev, history, kind) {
  ...
  var current = query || search ? { pathname: pathname, type: type, payload: payload, query: query, search: search } : { pathname: pathname, type: type, payload: payload };

  return _extends({}, action, { // keep any possible other non-FSA keys
    type: type,
    payload: payload,
    meta: _extends({}, meta, {
      location: {
...
exports.default = function (pathname, routesMap, serializer) {
  ...
  if (match) {
    ...
    return query || search ? { type: type, payload: payload, meta: { query: query, search: search } } : { type: type, payload: payload, meta: {} };
  }
  ...
  var meta = query || search ? { notFoundPath: pathname, query: query, search: search } : { notFoundPath: pathname };
...
var babelPluginFlowReactPropTypes_proptype_RoutesMap = __webpack_require__(2).babelPluginFlowReactPropTypes_proptype_RoutesMap || __webpack_require__(0).any;

var babelPluginFlowReactPropTypes_proptype_To = __webpack_require__(0).oneOfType([__webpack_require__(0).string, __webpack_require__(0).arrayOf(__webpack_require__(0).string), __webpack_require__(0).object]);
...
exports.default = function (history) {
  ...
  */
  ...
  var _beforeRouteChange = function _beforeRouteChange(store, next, history, action) {
  ...
  var _afterRouteChange = function _afterRouteChange(store, next, route) {
    var dispatch = middleware(store)(next); // re-create middleware's position in chain
    ...
    if ((typeof route === 'undefined' ? 'undefined' : _typeof(route)) === 'object') {
      (0, _attemptCallRouteThunk2.default)(dispatch, store.getState, route);
    }
...
var babelPluginFlowReactPropTypes_proptype_To = __webpack_require__(19).babelPluginFlowReactPropTypes_proptype_To || __webpack_require__(0).any;

var babelPluginFlowReactPropTypes_proptype_OnClick = __webpack_require__(0).oneOfType([__webpack_require__(0).oneOf([false]), __webpack_require__(0).func]);
...
var babelPluginFlowReactPropTypes_proptype_Store = __webpack_require__(29).babelPluginFlowReactPropTypes_proptype_Store || __webpack_require__(0).any;

var babelPluginFlowReactPropTypes_proptype_Connector = __webpack_require__(26).babelPluginFlowReactPropTypes_proptype_Connector || __webpack_require__(0).any;

var babelPluginFlowReactPropTypes_proptype_To = __webpack_require__(19).babelPluginFlowReactPropTypes_proptype_To || __webpack_require__(0).any;

var babelPluginFlowReactPropTypes_proptype_OnClick = __webpack_require__(43).babelPluginFlowReactPropTypes_proptype_OnClick || __webpack_require__(0).any;
...
Link.propTypes = {
  ...
  to: typeof babelPluginFlowReactPropTypes_proptype_To === 'function' ? babelPluginFlowReactPropTypes_proptype_To.isRequired ? babelPluginFlowReactPropTypes_proptype_To.isRequired : babelPluginFlowReactPropTypes_proptype_To : __webpack_require__(0).shape(babelPluginFlowReactPropTypes_proptype_To).isRequired,
  href: typeof babelPluginFlowReactPropTypes_proptype_To === 'function' ? babelPluginFlowReactPropTypes_proptype_To : __webpack_require__(0).shape(babelPluginFlowReactPropTypes_proptype_To),
  ...
  onPress: typeof babelPluginFlowReactPropTypes_proptype_OnClick === 'function' ? babelPluginFlowReactPropTypes_proptype_OnClick : __webpack_require__(0).shape(babelPluginFlowReactPropTypes_proptype_OnClick),
  onClick: typeof babelPluginFlowReactPropTypes_proptype_OnClick === 'function' ? babelPluginFlowReactPropTypes_proptype_OnClick : __webpack_require__(0).shape(babelPluginFlowReactPropTypes_proptype_OnClick),
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(32), __webpack_require__(78)(module)))
...
exports.default = function (initialState, routesMap) {
  return function () {
    ...
    if (action.type === _index.NOT_FOUND || routesMap[action.type] && (action.meta.location.current.pathname !== state.pathname || action.meta.location.current.search !== state.search || action.meta.location.kind === 'load')) {
      var _query = action.query || action.meta.query || action.payload.query;
      var _search = action.meta.location.current.search;

      // these keys wont show if undefined, which is cleaner in devtools/logging
      var querySearch = _query || _search ? { query: _query, search: _search } : {};
